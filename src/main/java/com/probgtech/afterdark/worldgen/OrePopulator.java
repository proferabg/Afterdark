...
public class OrePopulator extends BlockPopulator {
					...
					for (int i4 = k; i4 <= i1; i4++){
						...
						if (d13 * d13 + d14 * d14 < 1.0D){
							for (int i5 = m; i5 <= i2; i5++){
								...
								if ((d13 * d13 + d14 * d14 + d15 * d15 >= 1.0D) || (world.getBlockAt(i3, i4, i5).getType() != Material.NETHERRACK)){
									continue;
								}
	...
	public void populate(World world, Random random, Chunk chunk) {
		...
		for (i = 0; i < 50; ++i){
			...
			this.createPocket(world, Material.NETHER_QUARTZ_ORE, 8, x, y, z);
		}
		...
		for (i = 0; i < 50; ++i){
			...
			this.createPocket(world, Material.GLOWSTONE, 8, x, y, z);
		}
		...
		for (i = 0; i < 50; ++i){
			...
			this.createPocket(world, Material.EMERALD_ORE, 4, x, y, z);
		}
		...
		for (i = 0; i < 50; ++i){
			...
			this.createPocket(world, Material.GOLD_ORE, 6, x, y, z);
		}
		...
		for (i = 0; i < 50; ++i){
			...
			this.createPocket(world, Material.IRON_ORE, 8, x, y, z);
		}
		...
		for (i = 0; i < 50; ++i){
			...
			this.createPocket(world, Material.DIAMOND_ORE, 6, x, y, z);
		}
		...
		for (i = 0; i < 50; ++i){
			...
			this.createPocket(world, Material.LAPIS_ORE, 6, x, y, z);
		}
		...
		for (i = 0; i < 50; ++i){
			...
			this.createPocket(world, Material.COAL_ORE, 12, x, y, z);
		}
		...
		for (i = 0; i < 50; ++i){
			...
			this.createPocket(world, Material.REDSTONE_ORE, 6, x, y, z);
		}
	}
